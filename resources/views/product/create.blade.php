<x-app-layout>
    <x-slot name="header">
        <x-admin-title-page>Novo Produto</x-admin-title-page>
    </x-slot>
    <x-body>
        <form action="{{ route('admin.products.store') }}" method="post" class="grid grid-cols-12 contents-start col-span-12">
