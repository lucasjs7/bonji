<x-app-layout>
    ...
    <x-body>
        <form action="{{ route('admin.products.media.update', [$product->id, $media->id]) }}" method="post" enctype="multipart/form-data" class="grid grid-cols-12 contents-start col-span-12">
            @method('PUT')
